    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-4" style="margin-top:5px;">
                    <div class="panel panel-default">
                        <div class="row">
                            <div class="col-md-12">
                                <input type="text" id="txtBusca" class="form-control" placeholder="Nombre Usuario...">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mt-3" id="contenedorLista">
                @include('users.parcial.lista')
            </div>
        </div>
    </section>

    @include('modal.eliminar')
    <input type="hidden" value="{{ route('users.index') }}" id="urlLista">
@endsection
