            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        @include('includes.reporte.repote_empresa')
                        @endif
                        @if(Auth::user()->tipo == 'DISTRIBUIDOR')
                        @include('includes.reporte.reporte_distribuidor')
                        @endif
                    </div>
                </div>
            </div>
...
@include('reportes.modal.m_ordens')
@include('reportes.modal.m_entregas')
@include('reportes.modal.m_pagos')
@endsection
