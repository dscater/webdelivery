<div class="modal fade" id="m_ordens">
    <div class="modal-dialog">
        <div class="modal-content  bg-sucess">
            <div class="modal-header">
                <h4 class="modal-title">Lista de Ordenes</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                {!! Form::open(['route' => 'reportes.ordens', 'method' => 'get', 'target' => '_blank', 'id' => 'formordens']) !!}
                <div class="row">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="submit" class="btn btn-info" id="btnordens">Generar reporte</button>
                {!! Form::close() !!}
            </div>
        </div>
        <!-- /.modal-content -->
