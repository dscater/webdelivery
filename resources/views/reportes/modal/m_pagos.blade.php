<div class="modal fade" id="m_pagos">
    <div class="modal-dialog">
        <div class="modal-content  bg-sucess">
            <div class="modal-header">
                <h4 class="modal-title">Reporte Ingreso por Pagos</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                {!! Form::open(['route' => 'reportes.pagos', 'method' => 'get', 'target' => '_blank', 'id' =>
                'formpagos']) !!}
                <div class="row">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="submit" class="btn btn-info" id="btnpagos">Generar reporte</button>
                {!! Form::close() !!}
            </div>
        </div>
        <!-- /.modal-content -->
