...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Grupos Distribuidores</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Inicio</a></li>
                        <li class="breadcrumb-item active">Grupos Distribuidores</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            @if (Auth::user()->tipo == 'ADMINISTRADOR')
                                <a href="{{ route('distribuidors.create') }}" class="btn btn-info"><i
                                        class="fa fa-plus"></i>
                                    Nuevo</a>
                            @endif
                        </div>
                                    ...
                                    @foreach ($distribuidors as $distribuidor)
                                        <tr>
                                            ...
                                            <td class="btns-opciones">
                                                <a href="{{ route('distribuidors.edit', $distribuidor->id) }}"
                                                    class="modificar"><i class="fa fa-edit" data-toggle="tooltip"
                                                        data-placement="left" title="Modificar"></i></a>
                                                @if (Auth::user()->tipo == 'ADMINISTRADOR')

                                                    <a href="#"
                                                        data-url="{{ route('distribuidors.destroy', $distribuidor->id) }}"
...
@section('scripts')
    <script>
        ...
        $(document).on('click', 'table tbody tr td.btns-opciones a.eliminar', function(e) {
            e.preventDefault();
            let distribuidor = $(this).parents('tr').children('td').eq(1).text();
