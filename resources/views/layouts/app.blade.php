    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white bg-white">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown user user-menu bg-red">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-header bg-red">
                            <img src="{{ asset('imgs/users/' . Auth::user()->foto) }}" class="img-circle elevation-2"
                                alt="User Image">
                            <p class="text-black">{{ $nombre_usuario }}{{-- <small>Member since Nov. 2012</small> --}}</p>
                            <p class="text-black">{{ Auth::user()->tipo }}</p>
                        </li>
                        <!-- Menu Body -->
                        <li class="user-body">
                            <div class="row">
                ...
                <nav class="mt-2">
                    ...
                    with font-awesome or any other icon font library -->
                        ...
                        @if (Auth::user()->tipo == 'EMPRESA')
                            @include('includes.menu.menu_empresa')
                        @endif
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ date('Y') }} WEBDELIVERY</strong>
