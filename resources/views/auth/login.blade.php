                ...
                <form action="{{ route('login') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-2">
                            <button type="submit" class="btn btn-danger bg-red btn-block btn-sm">Acceder</button>
                        </div>
                        <div class="col-12 mb-2">
                            <a href="{{ route('register') }}" class="btn btn-default btn-block btn-sm">Registrarse</a>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
